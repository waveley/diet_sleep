...
diet_sleep_output %>% knitr::kable(col.names = c("Outcome", "Predictor", "Model"), "simple")
```
...
sleep_diet_output <- do_write_mods(sleep_diet_models) %>%
  ...
  relocate(outcome)
sleep_diet_output %>% knitr::kable(col.names = c("Outcome", "Predictor", "Model"), "simple")
```
